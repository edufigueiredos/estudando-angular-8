...
export class SubjectsComponent implements OnInit {
  ...
  protected subject: Subject<DataModel>;
  protected replaySubject: ReplaySubject<DataModel>;
  protected asyncSubject: AsyncSubject<DataModel>;
  protected behaviorSubject: BehaviorSubject<DataModel>;
